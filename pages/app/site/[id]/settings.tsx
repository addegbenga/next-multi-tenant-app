          ...
          <div className="flex flex-col space-y-6">
            ...
            {settings?.customDomain ? (
              ...
              >
                ...
                <button
                  type="submit"
                  className="px-5 py-3 text-white transition-all duration-150 ease-in-out bg-black border border-black border-solid rounded-md hover:text-black hover:bg-white w-28 font-cal focus:outline-none"
                >
